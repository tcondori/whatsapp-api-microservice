...
im    def get_by_line_id(self, line_id: str) -> Optional[Any]:
        """
    ...
    def get_by_phone_number_id(self, phone_number_id: str) -> Optional[Any]:
        ...
        try:
            ...
            raise DatabaseError("Error al obtener línea por phone_number_id", "get_by_phone_number_id")class BaseRepository:
    """
